...
rm -rf ./full-stack-fastapi-mysql/\{\{cookiecutter.project_slug\}\}/*

rsync -a --exclude=node_modules ./dev-fsfp/* ./full-stack-fastapi-mysql/\{\{cookiecutter.project_slug\}\}/

rsync -a ./dev-fsfp/{.env,.gitignore,.gitlab-ci.yml} ./full-stack-fastapi-mysql/\{\{cookiecutter.project_slug\}\}/
